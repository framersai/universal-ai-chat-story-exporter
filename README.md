...
[![Version](https://img.shields.io/badge/version-0.4.0-blue)](./public/manifest.json)
...
- **Four Output Formats** — Pick what fits the use case:
  ...
  - **PDF** (`.pdf`) — multi-page document with selectable text and role-tinted headers, generated client-side via jsPDF. v0.4.0 adds a hero image at the top — character avatar (Character.AI / Janitor AI) or adventure cover art (AI Dungeon).
